...
var lasts = document.getElementById("logs");
...
btns.addEventListener("click", function (e) {
  ...
  if (c >= 1) {
    ...
    pass.parentNode.nextElementSibling.nextElementSibling.classList.remove(
      "view"
    );
  }

  if (valueCpass !== valuePass) {
    cpass.parentNode.nextElementSibling.nextElementSibling.classList.add(
      "view"
    );
  } else {
    cpass.parentNode.nextElementSibling.nextElementSibling.classList.remove(
      "view"
    );
  }

  if (len < 8) {
    pass.parentNode.nextElementSibling.nextElementSibling.nextElementSibling.classList.add(
      "view"
    );
  } else {
    pass.parentNode.nextElementSibling.nextElementSibling.nextElementSibling.classList.remove(
      "view"
    );
  }
  ...
  if (mar.length == 0) {
    btns.parentNode.nextElementSibling.classList.add("view");
    lasts.classList.add("view");
